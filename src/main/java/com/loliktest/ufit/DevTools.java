...
public class DevTools {
    ...
    public List<ParsedRequest> getParsedRequests(List<LogEntry> entryList) {
        ...
        return resultList.stream().filter(parsedRequest -> !parsedRequest.statusCode.equals("200")).sorted(Comparator.comparing(ParsedRequest::getTime)).collect(Collectors.toList());
    }
